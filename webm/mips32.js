...
/*
	...
	This script requires following methods:
		...
		system.write32(address);
		system.read8(address);
		system.write8(address);
		system.wait();
...
mips32.exec=function(){
	...
	code=(code>>5)&0x3f;
	this.mnh=code;
	var mnemonic=this.commands[code];
	if (mnemonic) {
		return this[mnemonic]();
	} else {
		this.log("Invalid command:0x"+code.toString(16));
	}
};
mips32.commands=[
	"execSpecial", //000000
...
mips32.execSpecial=function(){
	var mnemonic=this.commandsSp[this.mnl];
	if (mnemonic) {
		return this[mnemonic]();
	} else {
...
mips32.execBranch=function(){
	var mnemonic=this.commandsSp[this.rt];
	if (mnemonic) {
		return this[mnemonic]();
	} else {
...
mips32.execCop0=function(){
	if (this.rs&0x10) { // CO (25th bit) is 1
		var mnemonic=this.commandsCp0[this.mnl];
		if (mnemonic) {
			return this[mnemonic]();
		} else {
...
mips32.execSpecial2=function(){
	var mnemonic=this.commandsSp2[this.mnl];
	if (mnemonic) {
		return this[mnemonic]();
	} else {
...
mips32.execSpecial3=function(){
	var mnemonic=this.commandsSp3[this.mnl];
	if (mnemonic) {
		return this[mnemonic]();
	} else {
