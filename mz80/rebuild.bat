: Example of compiling a C file: sdcc main.c -mz80 --code-loc 0x1200 --no-std-crt0 -Wlcrt\crt.asm.o
: Folloing code is written for compiling and linking multiple C files for an object.
@if "%1"=="" goto main
